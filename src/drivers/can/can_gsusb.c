...
/* GS_USB mode flags (used in flags field) */
#define GS_CAN_FLAG_LISTEN_ONLY      (1 << 0)
#define GS_CAN_FLAG_LOOP_BACK        (1 << 1)
#define GS_CAN_FLAG_TRIPLE_SAMPLE    (1 << 2)
#define GS_CAN_FLAG_ONE_SHOT         (1 << 3)
#define GS_CAN_FLAG_HW_TIMESTAMP     (1 << 4)
#define GS_CAN_FLAG_PAD_PKTS_TO_MAX_PKT_SIZE (1 << 7)
#define GS_CAN_FLAG_FD               (1 << 8)
